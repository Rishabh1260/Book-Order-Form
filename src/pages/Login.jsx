...
const Login = () => {
  ...
  return (
    <div className="flex max-lg:flex-col flex-row max-h-screen max-w-screen relative max-lg:justify-evenly max-lg:align-middle  ">
      <img
        src="/Background.jpg"
        alt="Background"
      ...
      <div className="h-auto  bg-custom-gray flex items-center justify-center align-middle ">
        <div className="w-auto h-auto p-12 bg-[#5782c147] rounded-3xl  border-solid  backdrop-blur-[25px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(25px)_brightness(100%)] [border-image:linear-gradient(to_bottom,rgba(88,130,193,0.49),rgba(88,130,193,0.11))_1]">
          <h2 className="text-2xl m item-center justify-center font-light text-black">
            Login
          </h2>
          <p className="text-[12px] font-thin text-black ">
            Welcome to SangeetmayChinmay{" "}
          </p>
          ...
          <div className="mb-5 flex-row items-center justify-center">
            ...
            <div className="relative w-full h-14 mb-8 flex justify-center  ">
              <div
                className="flex-row w-auto h-10 m-2 bg-white rounded-[10px] border border-solid border-[#bcbec0] "
              ...
              >
                ...
                <p className="text-black pl-10 p-2  font-light text-sm item-center">
                  Sign in with Google
                </p>
              </div>
            </div>
