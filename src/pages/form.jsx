...
<div  className=" lg:px-32 py-10 min-h-screen md:px-16 max-sm:px-5   bg-black"> 
<div className="border-b border-gray-900 lg:px-40 md:px-16 max-sm:px-8 py-20 bg-gray-900 rounded-2xl relative ">
    ...
    <div className="sm:col-span-2">
      ...
      <div className="mt-2">
        <select
          ...
          required
          className="block lg:w-full justify-center p-2 rounded-md border-0 py-2 text-white outline-none bg-custom-gray shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
        >
  ...
  <div className="mt-5 pl-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-3 md:grid-cols-3">
  ...
  <div className="flex gap-4 m-5 border border-blue-500 p-2 rounded-xl overflow-x-auto max-sm:flex-wrap ">
